    ...
    <?php while($record = mysqli_fetch_assoc($result)): ?>
        <tr>
            ...
            <td class="bm-table-icon">
                ...
                <?php else: ?>
                    <a href="#" onclick="return confirmModal('Are you sure you want to approve the image <?=$record['name']?>?', '/admin/video/list/approve/<?=$record['id']?>');">
            ...
            <td class="bm-table-icon">
                <a href="<?=ENV_DOMAIN?>/admin/video/edit/<?=$record['id']?>">
