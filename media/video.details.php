...
if(!$media['content_type'])
{
    ...
    header_redirect(ENV_DOMAIN.'/video/details/'.$_GET['key']);

}

define('APP_NAME', 'Stock Media');
define('PAGE_TITLE', 'Video Details');
...
<a
    href="<?=$_SERVER['HTTP_REFERER'] ?? ENV_DOMAIN.'/video/list'?>"
    class="w3-button w3-white w3-border"
>
    <i class="fa-solid fa-arrow-left fa-padding-right"></i> Back to Video List
</a>
...
<a
    ...
    class="w3-button w3-white w3-border"
>
    <i class="fa-solid fa-download fa-padding-right"></i> Download Video
</a>
